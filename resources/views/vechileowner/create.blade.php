            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Vehicle Owner Registration </li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Add Vehicle Owner</h3>
                        </div>
                            ...
                            <form role="form" method="POST" action="{{route('vechile_owner.store')}}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="owner_phone_first" class="form-control"
                                        ...
                                        <div class="form-group col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="owner_phone_second" class="form-control"
                                        ...
                                        <div class="form-group col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="owner_whatsapp" class="form-control"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row" id="bank_detail_div">
                                        ...
                                        <div class="form-group col-md-1">
                                            <label for="exampleInputEmail1">Remove</label>
                                            <a class="btn btn-danger" id="delete_button" onclick="remove_div(this)">-</a> </div>
                                        </div>
                                    @endforeach
                                </div>
                                @endif
                                <div class="card-body">
                                    <a class="btn btn-primary" id="add_button">Add Bank Details+</a>
