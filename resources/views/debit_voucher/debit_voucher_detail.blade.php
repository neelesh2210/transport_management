            ...
            <div class="container-fluid invoice-container">
              ...
              <div class="row align-items-center">
                <div class="col-sm-12 text-center">
                  <h4 class="text-7 mb-0">DEBIT VOUCHER</h4>
                </div>
              </div>
              <hr>
              </header>
              ...
              <!-- Main Content -->
              <main>
                  @php $lr=App\Invoice::where('id', $data['tax_invoice_id'])->first() @endphp
              <div class="row">
                <div class="col-sm-6 text-sm-right order-sm-1"> <strong>Date : </strong>{{$lr->lorry_recepit_date}}
                  <address>
                ...
                <div class="col-sm-6 order-sm-0"> <strong>LR Number :</strong> {{$lr->lorry_receipt_no}}
                  <address>
                  
                  
                  <!--<strong>Date : </strong>{{$lr->lorry_recepit_date}}<br />-->
              ...
              <!--<hr> -->
               ...
               <div class="row">
                <div class="col-sm-6">
                    ...
                    Rate : {{$data['rate']}} </br>
                    Advance Diesel : {{$data['diesel']}} </br>
                    Commission : {{$data['transporter_percent']}} %</br>
                    
                    Shorted Claim : {{$data['shorted_claim']}} </br>
                    Remarks : {{$data['remark']}} </br>
