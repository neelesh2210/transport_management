         ...
         @if(Session::get('data')!='')
          ...
          <div class="card">
            <div class="card-header">
              ...
              <h3 class="card-title">Truck Number : {{$data['vechile_number']}} </h3></br>
              @php $owner=App\VechileOwner::where('id', $data['owner_id'])->first() @endphp
              <h3 class="card-title">Truck Owner Name : {{$owner->ownwer_name}} </h3></br>
              <h3 class="card-title">Truck Owner Type : {{$owner->ownership_type}} </h3></br>
              <h3 class="card-title">Truck Owner Phone : {{$owner->owner_phone_first}} </h3></br>
              <h3 class="card-title">Truck Owner Email : {{$owner->owner_email}} </h3></br>
              <h3 class="card-title">Truck Owner Address : {{$owner->owner_address}} </h3></br>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    @php $debit=App\DebitVoucher::where('vechile_no', $data['id'])->get() @endphp
