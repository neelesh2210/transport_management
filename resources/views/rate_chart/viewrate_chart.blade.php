         ...
         @if(Session::get('data')!='')
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Rate Chart List</h3>
              @can('rate-chart-create')
              <a href="{{ route('rate_chart.create') }}" class="btn btn-primary btn-info" style="float:right;"><i class="fas fa-plus" aria-hidden="true"></i>  Add</a>
              @endcan
            </div>
            ...
            <span class="slider round"></span>
                  ...
                  <td>
                   <div class="btn-group">
      @can('rate-chart-edit')  
       <a href="{{route('rate_chart.edit',$item->id)}}" class="btn btn-primary btn-sm"><i class="fas fa-pencil-alt" aria-hidden="true"></i> Edit</a>
      @endcan
      @can('rate-chart-delete')
     <form action="{{ route('rate_chart.destroy', $item->id) }}" method="POST">
    @method('DELETE')
    @csrf
