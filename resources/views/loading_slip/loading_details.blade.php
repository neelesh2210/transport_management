            ...
            <div class="container-fluid invoice-container">
              ...
              <div class="row align-items-center">
                <div class="col-sm-12 text-center">
                  <h4 class="text-7 mb-0">LOADING SLIP</h4>
                </div>
              </div>
              <hr>
              </header>
              ...
              <div class="row">
                  <div class="col-md-6">
                      D.I. No / EGP No: {{$data['di_no']}}</br>
                      @php $truck=App\Truck::where('id', $data['truck_no'] )->first()  @endphp 
                      Vechile Number: {{$truck->vechile_number}}</br>
                      Owner Name: {{$data['owner_name']}}</br>
                      Owner Mobile No: {{$data['owner_mobile_no']}}</br>
                      @php $driver=App\Driver::where('id', $data['driver_name'] )->first()  @endphp 
                      Driver Name: {{$driver->driver_name}}</br>
                      Driver Id: {{$data['driver_id']}}</br>
                      Driver Mobile Number: {{$data['driver_mobile']}}</br>
                  </div>
                  <div class="col-md-6">
                      Cash Advance: {{$data['case_advance']}}</br>
                      Diesel Cash Advance: {{$data['diesel_case_advance']}}</br>
                      Diesel Quantity (Litre): {{$data['diesel_quantity']}}</br>
                      Diesel Slip Number: {{$data['diesel_slip_no']}}</br>
                      Material Name: {{$data['material_name']}}</br>
                      Driver Signature: {{$data['driver_signature']}}</br>
