                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        @if (isset($edit_data['id']))
                            <form role="form" method="POST" action="{{ route('loading_slip.update', $edit_data['id']) }}"
                                enctype="multipart/form-data">
                                @method('PUT')
                        @endif
                        @if (empty($edit_data['id']))
                            <form role="form" method="POST" action="{{ route('loading_slip.store') }}"
                                enctype="multipart/form-data">
                        @endif
                        @csrf
                        <div class="card-body">
                    ...
                    <input type="test" name="diesel_slip_no" class="form-control" id="exampleInputEmail1" placeholder="Enter Diesel Slip Number" value="@if (isset($edit_data['diesel_slip_no'])){{ $edit_data['diesel_slip_no'] }}@endif">
                                ...
                                <div class="form-group col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="material_name" id="material_name" class="form-control select2" style="width: 100%;" data-placeholder="Select Materials" multiple>
                                            <option value="">Select Material </option>
                                            @foreach (App\Material::where('delete_status',0)->where('status',1)->get() as $material)
                                ...
                                {{-- <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status">
                                            ...
                                            <option value="enable"
                                                @if (isset($edit_data['status']) && $edit_data['status'] == 'enable') {{ 'selected' }} @endif>Enable
                                            </option>
                                            <option value="disable"
                                                @if (isset($edit_data['status']) && $edit_data['status'] == 'disable') {{ 'selected' }} @endif>Disable
                                            </option>
                                        </select>
                                    </div>
                                </div> --}}
                                <input type="hidden" name="add_by" class="form-control" id="exampleInputPassword1"
