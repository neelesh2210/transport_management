...
<head>
    ...
    <link rel="stylesheet"
        href="{{ URL::asset('/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ URL::asset('/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css') }}">
    <link rel="stylesheet"
        href="{{ URL::asset('/plugins/datatables-responsive/css/responsive.bootstrap4.min.css') }}">
