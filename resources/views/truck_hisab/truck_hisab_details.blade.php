            ...
            <div class="container-fluid invoice-container">
              ...
              <div class="row align-items-center">
                <div class="col-sm-12 text-center">
                  <h4 class="text-7 mb-0">TRUCK HISAB</h4>
                </div>
              </div>
              <hr>
              </header>
              ...
              <!-- Main Content -->
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    Destination : {{$rate->destination}} ({{$rate->city_code}})</br>
                    Material Name : {{$data['material']}}</br>
                    Rate : {{$data['rate']}}</br>
                  ...
                  <div class="col-md-6">
                    Transporter Percent % : {{$data['transporter_percent']}}</br>
                    TAC % : {{$data['tac']}}</br>
                    Unloding by Company : {{$data['unloding']}}</br>
                    Cash Advance : {{$data['cash_advance']}}</br>
                    Diesel Cash Advance : {{$data['diesel']}}</br>
...
$(document).ready(function(){
  ...
  @include('layout/footer')@include('layout/header')
