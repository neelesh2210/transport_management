            ...
            <div class="container-fluid invoice-container">
              ...
              <div class="row align-items-center">
                <div class="col-sm-12 text-center">
                  <h4 class="text-7 mb-0">TRUCK PLACEMENT</h4>
                </div>
              </div>
              <hr>
              </header>
              ...
              <!-- Main Content -->
              <div class="text-center"><b>Truck Place Date : {{$data['truck_place_date']}}</b></div>
              <hr>
              <div class="row">
                  <div class="col-md-6">
                    Transporter Code : {{$data['transporter_code']}} </br>
                    @php $driver=App\Driver::where('id', $data['driver_name'] )->first()  @endphp 
                    Driver Name: {{$driver->driver_name}}</br>
                    Driver Id : {{$data['driver_id']}} </br>
                    Driver Mobile : {{$data['driver_mobile']}} </br>
 
                  </div>
                  <div class="col-md-6">
                    @php $truck=App\Truck::where('id', $data['vechile_no'] )->first()  @endphp 
                    Vechile Number: {{$truck->vechile_number}}</br>
                   	Dgnitity : {{$data['dgnitity']}} </br>
                   	@php $rate=App\RateChart::where('id', $data['destination_to'] )->first()  @endphp 
