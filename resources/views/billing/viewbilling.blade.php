         ...
         @if(Session::get('data')!='')
          ...
          <div class="card">
            <div class="card-header">
              ...
              @can('billing-create')
              <a href="{{ route('bill.create') }}" class="btn btn-primary btn-info" style="float:right;"><i class="fas fa-plus" aria-hidden="true"></i>  Add</a>
              @endcan
            </div>
              ...
              <table id="example1" class="table table-bordered table-striped">
               ...
               @foreach($data as $item)
                ...
                <td>{{$item->bill_number}}</td>
                  <td>{{$item->debite_voucher}}</td>
                 
                  
                  <td>
                   <div class="btn-group">
       @can('billing-edit') 
       <a href="{{route('bill.edit',$item->id)}}" class="btn btn-primary btn-sm"><i class="fas fa-pencil-alt" aria-hidden="true"></i> Edit</a>
       @endcan
       @can('billing-delete')
