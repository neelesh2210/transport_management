            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <form role="form" method="POST" action="{{ route('branch.store') }}" enctype="multipart/form-data" class="valid_form">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="branch_name" class="form-control" id="branch_name" placeholder="Enter Brnach Name" value="{{ old('branch_name') }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <div class="form-group">
                                            <label for="branch_code">Brnach Code<span class="red">*</span></label>
                                            <input type="text" name="branch_code" class="form-control" id="branch_code" placeholder="Brnach Code" value="{{ old('branch_code') }}" required>
                                    ...
                                    <div class="form-group col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="branch_address" class="form-control" id="branch_address" placeholder="Branch Address" value="{{ old('branch_address') }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal"
                        style="margin-right: 61%;">Close</button>
                    <button type="button" id="save_button" class="btn btn-primary" data-dismiss="modal">Add
                        Material</button>
                </div>
            </div>
        </div>
