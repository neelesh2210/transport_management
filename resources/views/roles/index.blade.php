@php $page_name="Role List" @endphp
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              ...
              @can('role-create')
              <a href="{{ route('roles.create') }}" class="btn btn-primary btn-info " style="float:right;"><i class="fas fa-plus" aria-hidden="true"></i> Add Role</a>
              @endcan
            </div>
